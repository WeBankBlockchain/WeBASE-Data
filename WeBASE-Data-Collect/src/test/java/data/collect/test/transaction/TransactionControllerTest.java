 ...
 */
package data.collect.test.transaction;
...
public class TransactionControllerTest {
    ...
    public void testGetTransList() throws Exception {
        ResultActions resultActions = mockMvc.perform(MockMvcRequestBuilders.get("/transaction/list/1/1/15"));
        resultActions.
    ...
    public void testGetTransactionReceipt() throws Exception {
        ResultActions resultActions = mockMvc.perform(MockMvcRequestBuilders.get("/transaction/receipt/1/0xda879949df6b5d75d2d807f036b461e0cebcc1abaccac119c9a282d3941a4818"));
        resultActions.
            andExpect(MockMvcResultMatchers.status().isOk()).
            andDo(MockMvcResultHandlers.print());
        System.out.println("=================================response:"+resultActions.andReturn().getResponse().getContentAsString());
