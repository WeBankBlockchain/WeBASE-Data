 ...
 * the License.
 */
package com.webank.webase.data.collect.txndaily;
...
public interface TxnDailyMapper {
     ...
     */
    List<LatestTransCount> queryLatestTransCount(@Param(value = "tableName") String tableName,
            @Param(value = "chainId") int chainId, @Param(value = "groupId") int groupId);
