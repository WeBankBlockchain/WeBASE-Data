...
public interface TbGasMapper {
    ...
    @Delete({ "delete from tb_gas", "where id = #{chainId,jdbcType=INTEGER}", "and group_id = #{groupId,jdbcType=INTEGER}", "and block_number = #{blockNumber,jdbcType=BIGINT}" })
     ...
     *
     */
    @Insert({ "insert into tb_gas (record_month, chain_id, ", "group_id, block_number, ", "trans_hash, block_timestamp, ", "user_address, record_type, ", "gas_value, gas_remain, ", "create_time, modify_time)", "values (#{recordMonth,jdbcType=INTEGER}, #{chainId,jdbcType=INTEGER}, ", "#{groupId,jdbcType=INTEGER}, #{blockNumber,jdbcType=BIGINT}, ", "#{transHash,jdbcType=VARCHAR}, #{blockTimestamp,jdbcType=TIMESTAMP}, ", "#{userAddress,jdbcType=VARCHAR}, #{recordType,jdbcType=TINYINT}, ", "#{gasValue,jdbcType=BIGINT}, #{gasRemain,jdbcType=BIGINT}, ", "NOW(), NOW())" })
    ...
    @Results({ @Result(column = "id", property = "id", jdbcType = JdbcType.INTEGER, id = true), @Result(column = "record_month", property = "recordMonth", jdbcType = JdbcType.INTEGER, id = true), @Result(column = "chain_id", property = "chainId", jdbcType = JdbcType.INTEGER), @Result(column = "group_id", property = "groupId", jdbcType = JdbcType.INTEGER), @Result(column = "block_number", property = "blockNumber", jdbcType = JdbcType.BIGINT), @Result(column = "trans_hash", property = "transHash", jdbcType = JdbcType.VARCHAR), @Result(column = "block_timestamp", property = "blockTimestamp", jdbcType = JdbcType.TIMESTAMP), @Result(column = "user_address", property = "userAddress", jdbcType = JdbcType.VARCHAR), @Result(column = "record_type", property = "recordType", jdbcType = JdbcType.TINYINT), @Result(column = "gas_value", property = "gasValue", jdbcType = JdbcType.BIGINT), @Result(column = "gas_remain", property = "gasRemain", jdbcType = JdbcType.BIGINT), @Result(column = "create_time", property = "createTime", jdbcType = JdbcType.TIMESTAMP), @Result(column = "modify_time", property = "modifyTime", jdbcType = JdbcType.TIMESTAMP) })
     ...
     * @mbg.generated
     */
    @Select({ "select", "id, record_month, chain_id, group_id, block_number, trans_hash, block_timestamp, ", "user_address, record_type, gas_value, gas_remain, create_time, modify_time", "from tb_gas", "where id = #{id,jdbcType=INTEGER}", "and record_month = #{recordMonth,jdbcType=INTEGER}" })
    @Results({ @Result(column = "id", property = "id", jdbcType = JdbcType.INTEGER, id = true), @Result(column = "record_month", property = "recordMonth", jdbcType = JdbcType.INTEGER, id = true), @Result(column = "chain_id", property = "chainId", jdbcType = JdbcType.INTEGER), @Result(column = "group_id", property = "groupId", jdbcType = JdbcType.INTEGER), @Result(column = "block_number", property = "blockNumber", jdbcType = JdbcType.BIGINT), @Result(column = "trans_hash", property = "transHash", jdbcType = JdbcType.VARCHAR), @Result(column = "block_timestamp", property = "blockTimestamp", jdbcType = JdbcType.TIMESTAMP), @Result(column = "user_address", property = "userAddress", jdbcType = JdbcType.VARCHAR), @Result(column = "record_type", property = "recordType", jdbcType = JdbcType.TINYINT), @Result(column = "gas_value", property = "gasValue", jdbcType = JdbcType.BIGINT), @Result(column = "gas_remain", property = "gasRemain", jdbcType = JdbcType.BIGINT), @Result(column = "create_time", property = "createTime", jdbcType = JdbcType.TIMESTAMP), @Result(column = "modify_time", property = "modifyTime", jdbcType = JdbcType.TIMESTAMP) })
     ...
     * @mbg.generated
     */
    @Update({ "update tb_gas", "set chain_id = #{chainId,jdbcType=INTEGER},", "group_id = #{groupId,jdbcType=INTEGER},", "block_number = #{blockNumber,jdbcType=BIGINT},", "trans_hash = #{transHash,jdbcType=VARCHAR},", "block_timestamp = #{blockTimestamp,jdbcType=TIMESTAMP},", "user_address = #{userAddress,jdbcType=VARCHAR},", "record_type = #{recordType,jdbcType=TINYINT},", "gas_value = #{gasValue,jdbcType=BIGINT},", "gas_remain = #{gasRemain,jdbcType=BIGINT},", "create_time = #{createTime,jdbcType=TIMESTAMP},", "modify_time = #{modifyTime,jdbcType=TIMESTAMP}", "where id = #{id,jdbcType=INTEGER}", "and record_month = #{recordMonth,jdbcType=INTEGER}" })
