...
-- ----------------------------
INSERT INTO tb_contract (contract_id,chain_id,group_id,contract_path,contract_name,contract_source,contract_abi,contract_bin,bytecode_bin,contract_type,description,create_time,modify_time) VALUES 
(1,0,0,'/','SystemConfigPrecompiled','','[{"constant":false,"inputs":[{"name":"key","type":"string"},{"name":"value","type":"string"}],"name":"setValueByKey","outputs":[{"name":"","type":"int256"}],"payable":false,"stateMutability":"nonpayable","type":"function"}]','','',1,'system contract','2020-06-08 17:50:11','2020-06-08 17:50:11');

INSERT INTO tb_contract (contract_id,chain_id,group_id,contract_path,contract_name,contract_source,contract_abi,contract_bin,bytecode_bin,contract_type,description,create_time,modify_time) VALUES 
(2,0,0,'/','TableFactoryPrecompiled','','[{"constant":false,"inputs":[{"name":"tableName","type":"string"},{"name":"key","type":"string"},{"name":"valueField","type":"string"}],"name":"createTable","outputs":[{"name":"","type":"int256"}],"payable":false,"stateMutability":"nonpayable","type":"function"}]','','',1,'system contract','2020-06-08 17:50:11','2020-06-08 17:50:11');
